...
export default async function ProfileEditPage() {
  ...
  return (
    <div data-testid="editProfilePage" className="min-h-screen bg-gradient-to-br from-purple-50 via-fuchsia-50 to-violet-50 dark:from-purple-950 dark:via-fuchsia-950 dark:to-violet-950">
