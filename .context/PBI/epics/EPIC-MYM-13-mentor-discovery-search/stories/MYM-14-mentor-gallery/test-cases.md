## 🧪 Shift-Left Test Cases - Generated 2025-11-12
...
#### **TC-001: Verificar que solo los mentores aprobados se muestran en la galería**
**Related Scenario:** Scenario 1 (Refined AC above)
**Type:** Positive, **Priority:** Critical, **Test Level:** E2E
**Preconditions:**
- Existen 3 mentores en la DB:
  - Mentor A: `is_verified = true`
  - Mentor B: `is_verified = true`
  - Mentor C: `is_verified = false`
- El usuario no necesita estar logueado.
**Test Steps:**
1. Navegar a la página `/mentors`.
2. Esperar a que la galería de mentores cargue.
3. Verificar los nombres de los mentores que se muestran.
**Expected Result:**
- **UI:** La galería muestra las tarjetas del Mentor A y Mentor B. La tarjeta del Mentor C NO se muestra.
...
#### **TC-008: API - Verificar que el endpoint de API no devuelve mentores no verificados**
**Related Scenario:** Integration
**Type:** Integration, **Priority:** Critical, **Test Level:** API
**Preconditions:**
- Existen 2 mentores verificados y 1 no verificado en la DB.
