...
- **Phases Executed:** 8 (template completo) + 3 tests adicionales fuera del template
- **Constraints Verified:** 8 de 8 (100%)
...
| UNIQUE | 1 | 1 | `unique_participants` blocks duplicate conversation pairs |
| NOT NULL | 1 | 1 | `participant_2_id` required on conversations |

**Total: 7/7 constraints working correctly. No test data left in DB.**
...
- [ ] API Testing exploratorio — pendiente
- [ ] Actualizar `final-test-results.md` con resultados de API cuando se complete
- [ ] Cerrar MYM-57 tras completar las 3 capas de testing
